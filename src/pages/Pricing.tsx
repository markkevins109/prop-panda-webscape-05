            ...
            {plans.map((plan, index) => (
              <div 
                ...
                className={`border rounded-xl overflow-hidden shadow-sm transition-all ${
                  plan.popular ? "border-primary relative transform md:-translate-y-4 scale-105" : ""
                }`}
              >
                {plan.popular && (
      ...
      <section className="section-padding bg-secondary">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <NavLink to="/case-studies" className="btn-primary inline-flex items-center mt-4">
      ...
      <section className="pb-20">
        <div className="container-custom">
          <div className="bg-primary/5 rounded-xl p-8 flex flex-col md:flex-row items-center justify-between">
            ...
            <NavLink to="/case-studies" className="btn-primary whitespace-nowrap">
              Try Risk-Free
            </NavLink>
          </div>
        </div>
